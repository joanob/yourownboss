...
func RegisterProductionRoutes(r chi.Router, svc *service.ProductionService, rateLimiter *cache.RateLimiter) {
	r.Route("/company/production/buildings", func(r chi.Router) {
		...
		r.Route("/{id}", func(r chi.Router) {
			...
			r.Post("/start", StartProductionHandler(svc, rateLimiter))
